...
int main()
{
    ...
    assert_param(xTaskCreate(GreenTask, "GreenTask", stack_size, nullptr, tskIDLE_PRIORITY + 2, nullptr) == pdPASS);
    assert_param(xTaskCreate(BlueTask, "BlueTask", stack_size, nullptr, tskIDLE_PRIORITY + 1, &blueTaskHandle) == pdPASS);
    xTaskCreateStatic(RedTask, "RedTask", stack_size, nullptr, tskIDLE_PRIORITY + 1, RedTaskStack, &RedTaskTCB);
